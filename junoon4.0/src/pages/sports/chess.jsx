...
import Chess from "../../assets/schedule/chess.png";
    ...
    <main className="bg-black min-h-screen pt-28 pb-24 px-6 md:px-10">
      <div className="relative mx-auto max-w-4xl space-y-10">
        ...
        >
          {/* Register */}
          <a
            href="https://forms.gle/7X8rEgP8EZ7fgmYBA"
            target="_blank"
  ...
  schedule Pubilsh SOON
        ...
        >
          ...
          <p className="text-sm text-slate-300">
            ...
            or rules, feel free to contact the Chess council below.
          </p>
      ...
      >
        <h2 className="text-xl font-bold text-white">Chess Highlights</h2>

        <p className="text-sm text-slate-300 max-w-2xl">
          Glimpses from previous Junoon Chess tournaments — passion, teamwork
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          {[
            "/memories/chess/chess.jpeg",
            "/memories/chess/chess2.jpeg",
