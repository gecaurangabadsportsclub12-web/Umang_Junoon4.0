    ...
    <main className="bg-black min-h-screen pt-28 pb-24 px-6 md:px-10">
      <div className="relative mx-auto max-w-4xl space-y-10">
        ...
        <nav className="flex items-center gap-1 text-xs text-slate-400">
          ...
          <FiChevronRight className="text-[0.7rem]" />
          <span className="text-slate-200">Cricket</span>
        </nav>
        ...
        >
          {/* Register */}
          <a
            href="https://docs.google.com/forms/d/e/1FAIpQLSc-PByCJ51C6RjnU3UxaTkTglsqp4N20rAbkdrEIT5ScAxvxQ/viewform?usp=dialog"
            target="_blank"
...
>
  schedule Pubilsh SOON
      ...
      >
        <h2 className="text-xl font-bold text-white">Cricket Highlights</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          {[
            "/memories/cricket/cric1.jpeg",
            "/memories/cricket/cric2.jpeg",
            "/memories/cricket/cric3.jpeg",
            "/memories/cricket/cric4.jpeg",
