    ...
    <main className="bg-black min-h-screen pt-28 pb-24 px-6 md:px-10">
      <div className="relative mx-auto max-w-4xl space-y-10">
        ...
        <nav className="flex items-center gap-1 text-xs text-slate-400">
          ...
          <FiChevronRight className="text-[0.7rem]" />
          <span className="text-slate-200">Table Tennis</span>
        </nav>
        ...
        >
          {/* Register */}
          <a
            href="https://forms.gle/4CjDbavs6FWqZCSQ8"
            target="_blank"
  ...
  schedule Pubilsh SOON
        ...
        >
          ...
          <p className="text-sm text-slate-300">
            ...
            or rules, feel free to contact the TT council below.
          </p>
      ...
      >
        <h2 className="text-xl font-bold text-white">Table Tennis Highlights</h2>

        <p className="text-sm text-slate-300 max-w-2xl">
          Glimpses from previous Junoon TT tournaments — passion, teamwork
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          {[
            ...
            "/memories/tt/tt.jpeg",
            "/memories/tt/tt2.jpeg",
            "/memories/tt/tt3.jpeg",
            "/memories/tt/tt4.jpeg",
