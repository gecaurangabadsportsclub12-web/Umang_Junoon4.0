  ...
  return (
    <main className="bg-black min-h-screen pt-28 pb-24 px-6 md:px-10">
      <div className="relative mx-auto max-w-4xl space-y-10">
        ...
        >
          {/* Register */}
          <a
            href="https://forms.gle/ahpo1CEyup9CqxUWA"
            target="_blank"
    ...
    "
      ...
      "
            ...
            >
              {[tugofwarboys, tugofwargirls].map((src, idx) => (
                <div
                  key={idx}
                  className="
  ...
  schedule Pubilsh SOON
        ...
        >
          ...
          <p className="text-sm text-slate-300">
            ...
            or rules, feel free to contact the Tug of War council below.
          </p>
      ...
      >
        ...
        <p className="text-sm text-slate-300 max-w-2xl">
          Glimpses from previous Junoon Tug of War tournaments — passion, teamwork
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          {[
            "/memories/tugofwar/tug.jpeg",
            "/memories/tugofwar/tug2.jpeg",
