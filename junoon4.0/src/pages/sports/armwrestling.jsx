    ...
    <main className="bg-black min-h-screen pt-28 pb-24 px-6 md:px-10">
      <div className="relative mx-auto max-w-4xl space-y-10">
        ...
        <nav className="flex items-center gap-1 text-xs text-slate-400">
          ...
          <FiChevronRight className="text-[0.7rem]" />
          <span className="text-slate-200">Arm Wrestling</span>
        </nav>
        ...
        >
          {/* Register */}
          <a
            href="https://forms.gle/hDUNFZW17vAbLhsT8"
            target="_blank"
  ...
  schedule Pubilsh SOON
        ...
        >
          ...
          <p className="text-sm text-slate-300">
            ...
            or rules, feel free to contact the ArmWrestling council below.
          </p>
      ...
      >
        <h2 className="text-xl font-bold text-white">Arm Wrestling Highlights</h2>

        <p className="text-sm text-slate-300 max-w-2xl">
          Glimpses from previous Junoon Arm Wrestling tournaments — passion, teamwork
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          {[
            "/memories/armwrestling/arm.jpeg",
            "/memories/armwrestling/arm2.jpeg",
